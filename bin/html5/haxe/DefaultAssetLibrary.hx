...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("img/foto.png", __ASSET__img_foto_png);
		type.set ("img/foto.png", AssetType.IMAGE);
...
@:keep @:bind #if display private #end class __ASSET__img_foto_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:image("assets/img/foto.png") #if display private #end class __ASSET__img_foto_png extends lime.graphics.Image {}
